...
export const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    'login.domainRestrictionNotice': 'Acesso restrito a e-mails corporativos pré-autorizados ou domínio da empresa.',
    'login.unauthorizedDomainError': 'Erro de domínio não autorizado: Seu e-mail não pertence ao domínio corporativo permitido ou não foi pré-autorizado.',
  ...
  en: {
    ...
    'login.loginPill': 'LOGIN',
    'login.domainRestrictionNotice': 'Access restricted to pre-authorized corporate emails or company domain.',
    'login.unauthorizedDomainError': 'Unauthorized domain error: Your email does not belong to the allowed corporate domain or is not pre-authorized.',
